                    ...
                    <div class="contact_form wow fadeInLeft">
                        ...
                        <form action="{{route('storemessage')}}" class="contactform" method="post">
                            ...
                            <p class="comment-form-author">
                                ...
                                <input type="text" name="name" placeholder="Name & Surname" size="30"
                                       required="required">
                            </p>
                            <p class="comment-form-author">
                                <label for="author"> <span class="required"></span></label>
                                <input type="text" name="phone" placeholder="Phone Number" size="30"
                                       required="required">
                            </p>
                            ...
                            <p class="comment-form-comment">
                                ...
                                <textarea name="message" cols="45" rows="8" placeholder="Your Message"
                    ...
                    <div class="contact_address wow fadeInRight">
                        ...
                        <div class="address_group">
                            <ul class="footer_social">
                                <li><a href="https://www.instagram.com/karabukuniv/
" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Instagram"><i
                                            class="fa fa-facebook"></i></a></li>
                                <li><a href="https://twitter.com/krbkuni" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip"
                                       data-original-title="Twitter"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://tr.linkedin.com/school/karabuk-university/" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip"
